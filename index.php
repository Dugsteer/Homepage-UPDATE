 ...
 <div class="content-5">
  <figure class="content-5__img">
    ...
    <div class="content-5__text">
      <h2 class="content-title">Play Any Boardgame</h2>
      <p class="content-1__text">
  ...
  <div class="content-6__text">
    <h2 class= "content-title">Photo Flashcards</h2>
    <p class="content-1__text">
...
<div class="content-8">
  <figure class="content-8__img">
    ...
    <div class="content-8__text">
     <h2 class= "content-title">Grammar Mazes</h2>
      <p class="content-1__text">
        All of the <a href="questions-maze.html">grammar mazes </a>help student awareness of grammar mistakes. The aim is to have a clean run all the way through!
      </p>
    </div>
</div>
