...
<body>
    ...
    <div class="content">
      ...
      $href = "text-maze.php";
      $text="There are three different sets of cards in each of our matching card games. Turn up two cards and if a picture matches a word, you win them. How fast can you clear the board?";  $level="Elementary"; 
      $time="10 mins"; 
      $icon="online";  
      include "./content-box-tall.php" ?>
